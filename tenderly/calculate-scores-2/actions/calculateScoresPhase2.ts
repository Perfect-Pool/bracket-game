...
export const calculateScoresPhase2: ActionFn = async (context: Context, event: Event) => {
    ...
    const CONTRACT_ADDRESS = await context.secrets.get("baseSepolia.olympicsBracketTicket.contract");
    const abi = [
        {
            "inputs": [
                {
